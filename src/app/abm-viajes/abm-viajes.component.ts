...
export class AbmViajesComponent implements OnInit {
    ...
    public latitude: number;
       ...
       @ViewChild("pickupInput") pickupInputElementRef: ElementRef;
        ...
        public @ViewChild("pickupOutput") pickupOutputElementRef: ElementRef;
       ...
       ngOnInit() {
        ...
        // this.mapCustomStyles = this.getMapCusotmStyles();
         ...
         this.mapsAPILoader.load().then(() => {
             let autocompleteInput = new google.maps.places.Autocomplete(this.pickupInputElementRef.nativeElement, {    types: ["address"]         });
